...
export default {
    ...
    methods: {
        ...
        calcResizeLimits() {
            ...
            const limits = {
                ...
                // left: { min: parentLim, max: this.maxWidth?this.maxWidth: left + (width - minWidth) },
                // right: { min: parentLim, max: this.maxWidth?this.maxWidth: right + (width - minWidth) },
                // top: { min: parentLim, max: this.maxHeight?this.maxHeight: top + (height - minHeight) },
                // bottom: { min: parentLim, max: this.maxHeight?this.maxHeight: bottom + (height - minHeight) },
            };
    ...
    computed: {
        positionStyle() {
            ...
            return {
                top: this.cusTop? this.cusTop: this.top + 'px',
                left: this.cusLeft? this.cusLeft: this.left + 'px',
				width: this.cusWidth? this.cusWidth: this.w == 'auto' ? 'auto' : w + 'px',
                height: this.cusHeight? this.cusHeight: this.h == 'auto' ? 'auto' : h + 'px',
				transition: this.transition? this.transition: undefined
                // zIndex: this.zIndex,
            };
        },
        ...
        // sizeStyle(){
        //     return {
        //         width: this.cusWidth? this.cusWidth: this.w == 'auto' ? 'auto' : this.width + 'px',
        //         height: this.cusHeight? this.cusHeight: this.h == 'auto' ? 'auto' : this.height + 'px',
		// 		transition: this.transition? this.transition: undefined
        //     };
        // },
